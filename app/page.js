...
export const metadata = {
  ...
  title: "Garagem de luxo — Estética Automotiva Premium",
  ...
  openGraph: {
    ...
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Garagem de luxo — Estética Automotiva Premium" }],
    locale: "pt_BR",
    type: "website",
  },
  twitter: {
...
export default function Home() {
  ...
  const jsonLd = {
    ...
    "geo": { "@type": "GeoCoordinates", "latitude": -23.6828551, "longitude": -46.6260021 },
    ...
    <main className="min-h-screen bg-[#0A0A0A] text-[#F5F5F5] font-sans selection:bg-[#C9A227] selection:text-black">
      ...
      <nav className="fixed w-full z-50 p-6 flex justify-between items-center bg-black/90 backdrop-blur-xl border-b border-white/5">
        <div className="relative w-48 h-16 group">
          ...
          <Image src="/Logo.png" alt="Logo Garagem de luxo" fill className="object-contain relative z-10 scale-125 drop-shadow-[0_0_15px_rgba(201,162,39,0.3)]" priority />
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8 text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <a href="https://www.google.com/maps/dir/?api=1&destination=Rua+João+de+Almeida+74+Centro+Diadema+SP7" target="_blank" className="inline-block px-10 py-4 bg-white text-black font-bold text-xs uppercase tracking-widest hover:bg-[#C9A227] transition-all">
                  Traçar Rota
                </a>
          ...
          <div className="w-full h-[400px] grayscale opacity-60 border border-white/10 rounded-sm overflow-hidden shadow-2xl bg-[#111]">
            <iframe 
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3653.945447788414!2d-46.6260021!3d-23.6828551!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94ce335e1da49ed9%3A0xd1297bd77206b47e!2sGaragem%20de%20luxo!5e0!3m2!1spt-BR!2sbr!4v1709123456789!5m2!1spt-BR!2sbr" 
